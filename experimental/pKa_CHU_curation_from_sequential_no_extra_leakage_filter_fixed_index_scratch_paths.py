...
external_matches.to_csv(
    "external_train_tanimoto_matches_ge_0p85.csv",
    index=False
)

pkachu_matches.to_csv(
    "training_rows_dropped_due_to_external_tanimoto_ge_0p85.csv",
    index=True
)
...
if len(remaining_matches) > 0:
    ...
    remaining_matches.to_csv(
        "WARNING_remaining_external_train_tanimoto_matches_ge_0p85.csv",
        index=False
    )
else:
